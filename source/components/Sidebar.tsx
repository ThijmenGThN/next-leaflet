...
const navigation = [
    ...
    { name: 'Services', href: '/dash/services', icon: ServerStackIcon },
    { name: 'Documents', href: '/dash/documents', icon: DocumentDuplicateIcon },
    { name: 'Invoices', href: '/dash/invoices', icon: CreditCardIcon },
    { name: 'Support', href: '/dash/support', icon: LifebuoyIcon },
]
                                                    ...
                                                    {navigation.map((item) => (
                                                        <li key={item.name}>
                                                            ...
                                                            >
                                                                <item.icon
                                                                    className={classNames(
                                                                        item.href == usePathname() ? 'text-primary' : 'text-gray-400 group-hover:text-primary',
                                                                        'h-6 w-6 shrink-0'
                                                                    )}
                                                                    aria-hidden="true"
                                                                />
